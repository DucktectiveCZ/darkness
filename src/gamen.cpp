...
int game::m_render() {
    ...
    for (auto drawable : m_drawables) {
        ...
        case game::DrawableType::TEXTURE:
            // TODO: Implement
            break;
        case game::DrawableType::COLOR:
            auto dimesions = &drawable.getDimensions();
            auto color = drawable.getColor();
            SDL_SetRenderDrawColor(m_renderer, color.r, color.g, color.b, color.a);
            SDL_RenderFillRect(m_renderer, dimesions);
        }
    }
